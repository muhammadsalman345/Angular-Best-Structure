...
import { AdminService } from 'src/app/pages/private-page/Admin-dashboard/admin-service/admin.service';
...
ngOnInit(): void {
    // this.users$ = this.apiService.getUsers('users');

    // this.subscription = this.apiService.getUsers('users').subscribe((data) => {
